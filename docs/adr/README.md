...
| [0013](./0013-echo-cancellation-webrtc-aec3.md) | エコーキャンセルは WebRTC AEC3、処理後音声を録音・文字起こしに使う | Accepted |
...
- 手順の正典は`.agents/skills/adr/SKILL.md`。Claude Codeでは`/adr <タイトル>`でも
  起動できる。
