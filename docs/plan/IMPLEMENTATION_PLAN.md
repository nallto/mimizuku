...
| AEC-1 | WebRTC APM ベンダリング + ブリッジ + オフライン検証(#61) | S4 | AEC-0 | 未着手 |
| AEC-2 | AEC 同期層(フレーマ・リングバッファ・ドリフト計測)(#62) | S4 | AEC-0 | 未着手 |
| AEC-3 | AEC ライブ統合(両方モード)(#63) | AEC-1, AEC-2 | — | 未着手 |
| AEC-4 | マイクのみモードの参照 tap(#64) | AEC-3 | — | 未着手 |
...
- **AEC-4(#64)**: 「マイクのみ」モードでも隠し参照 tap で AEC を効かせる(TCC 未許可時は graceful degradation)。完了で #59 クローズ。
